...
let ejemplo_domicilio = new Domicilio_1.Domicilio(6, "Caldero de la barca 2991", ejemplo, "Devoto", 86, "Nicolás Vilches");
let ejemplo_domicilio2 = new Domicilio_1.Domicilio(7, "Caldero de la barca 2993", ejemplo, "Devoto", 78, "Nicolá Vilche");
let ejemplo_corte = new Corte_1.Corte(5, ejemplo_inicio, ejemplo_fin, ejemplo_domicilio);
...
app.listen(port, () => { console.log("aaaa"); });
...
app.delete("/domicilios/borrar_casa_mayor_consumo", (_req, _res) => {
    let consumo_mayor = 0;
